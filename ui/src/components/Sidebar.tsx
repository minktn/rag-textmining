...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed md:static inset-y-0 left-0 z-40 flex flex-col bg-sidebarBg border-borderDark transition-all duration-300 ease-in-out ${
          isOpen
            ? 'w-64 translate-x-0 border-r opacity-100'
            : '-translate-x-full md:translate-x-0 md:w-0 border-r-0 overflow-hidden opacity-0 pointer-events-none'
        }`}
      >
        <div className="w-64 h-full flex flex-col flex-shrink-0">
          ...
          <div className="p-3.5 flex flex-col gap-3 border-b border-borderDark/40">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={onToggleSidebar}
                className="p-1.5 rounded-lg text-gray-400 hover:bg-hoverBg hover:text-white transition-colors"
                title="Đóng sidebar"
              >
          ...
          <div className="p-3 border-t border-borderDark/40 bg-sidebarBg/50 text-xs text-gray-400 flex flex-col gap-1.5">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300 font-medium">VietLegal RAG Server</span>
              </div>
